...
import Skeleton from '../../shared/components/skeleton/DetailSkeletonUI.tsx';
import {
  getProfileImageUrl,
  useApiUrlStore,
  useCommentDataStore,
        ...
        <PostWrapper>
          ...
          <MainPostWrapper>
            ...
            <FooterWrapper>
              ...
              <LikeBtn onClick={() => onLikeBtn(postData.post_id)}>
                좋아요
              </LikeBtn>
            </FooterWrapper>
          </MainPostWrapper>
                ...
                <CommentUpper>
                  ...
                  {commentnickname === comments.nickname ? (
                    <ButtonWrapper>
                      <CommentDelete
                        onClick={() =>
                          deleteCommet(postData.post_id, comments.comment_id)
                        }
                      >
                        삭제
                      </CommentDelete>
                      {isediting === comments.comment_id ? (
                        <EditBtn
                          onClick={() =>
                            updateComment(postData.post_id, comments.comment_id)
                          }
                        >
                          완료
                        </EditBtn>
                        ...
                        <CommentUpdate
                          onClick={() => handleEdit(comments.comment_id)}
                        >
                          수정
                        </CommentUpdate>
                      )}
